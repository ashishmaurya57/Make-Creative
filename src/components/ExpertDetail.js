                ...
                <div class="row">
                                ...
                                <nav>
                                    <div class="nav nav-tab" id="nav-tab" role="tablist">
                                        <button class="nav-links active" id="nav-one-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true">
                                            <img src="assets/img/product/product-details-sm-1.png" alt=""/>
                                        </button>
                                        <button class="nav-links" id="nav-two-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">
                                            <img src="assets/img/product/product-details-sm-2.png" alt=""/>
                                        </button>
                                        <button class="nav-links" id="nav-three-tab" data-bs-toggle="tab"
                                            ...
                                            <img src="assets/img/product/product-details-sm-3.png" alt=""/>
                                        </button>
                                        <button class="nav-links" id="nav-four-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">
                                            <img src="assets/img/product/product-details-sm-4.png" alt=""/>
                                        </button>
                                    </div>
                                </nav>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="tp-shop-details__right-warp">
                            <h3 class="tp-shop-details__title-sm">Overcoat Jacket Clothing Suitsupply Double</h3>
